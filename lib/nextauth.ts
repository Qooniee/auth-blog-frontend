...
// 共通のAPIリクエスト DjangoのAPIを呼び出すためのもの
...
// アクセストークンの検証 Djangoのエンドポイント/api/auth/jwt/verify/
...
// アクセストークンの更新 Djangoのエンドポイント/api/auth/jwt/refresh/
...
// ユーザー情報取得 Djangoのエンドポイント/api/auth/jwt/create/
...
export const getAuthSession = async () => {
  ...
  // ユーザー情報を取得 Djangoのエンドポイント/api/auth/users/me/
  const user = await fetchAPI("/api/auth/users/me/", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
